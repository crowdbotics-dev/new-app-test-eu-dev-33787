...
## Project Structure
    ...
    ├── new_app_test_eu_dev_33787  # Django project configurations
...
1. Clone this repo and `cd new_app_test_eu_dev_33787`
...
2. Clone this repo and `cd new_app_test_eu_dev_33787`
